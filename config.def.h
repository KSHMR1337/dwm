...
static const unsigned int cornerradius =
    8;                               /* corner radius for rounded borders */
...
static const int scalepreview =
    4; /* preview scale factor (mw/scalepreview wide) */
...
/* Delay in ms before the alt-tab overlay appears. If the modifier is
 * released within this window, the workspace switches without flashing
 * the overlay. */
#define ALTTAB_RELEASE_MS 100
